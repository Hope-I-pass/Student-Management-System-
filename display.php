    ...
    <div class="container my-5 mx-8 shadow p-3 mb-5 bg-white rounded">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    <a href='update.php?updateid={$stuid}' class='btn btn-sm btn-primary'>Update</a>
                    <a href='delete.php?deleteid={$stuid}' class='btn btn-sm btn-danger'>Delete</a>
                </td>
            ...
            ";
                ...
                ";
                    ...
                    echo "
                <br>
                <a href='attendance_record.php' class='btn btn-sm btn-info mt-2'>Records</a>
                </td>
            </tr>
            ";
                }
